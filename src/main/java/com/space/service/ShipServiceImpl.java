...
import com.space.exception.ErrorShipParams;
...
public class ShipServiceImpl implements ShipService{
    ...
    @Override
    public List<Ship> countShips(Specification<Ship> shipSpecification) {
    ...
    public Ship saveShip(Ship ship) {
        if (ship.getName() == null
            ...
            throw new ErrorShipParams("One of Ship params is null");
    ...
    public Long checkAndParseId(String id) {
        if (id == null || id.equals("") || id.equals("0"))
            throw new ErrorShipParams("Некорректный ID");
        ...
        try {
            ...
            throw new ErrorShipParams("ID не является числом", e);
        }
    }
